...
y1 = 0;
y2 = 0;
arcLength = 1.016854078675318;%1.13608;%1.01927;%1.4685;-3%1.01927;-6%1.4685;-3%1.10323;%1.86613;-3%2.27177;-3%1.39368;-100%1.13608;-6
%Timesteps = 0.23;
...
elseif ODESystemType == 1 
    [smesh,~,~,antwort3,antwort4,~,~,~,~,~,~,~]...
    = GenerateProb2ODESysMeshSymVel(xmesh, valx1tau(1,:), ...
...
for Lambda = Lambdas
    ...
    disp(Slope);
        ...
        elseif ODESystemType == 1
            [smesh, antwort1, antwort2,~,~, antwort5, antwort6, antwort7,...
                antwort_EVP, antwort_Infinite, antwort_endpoint, antwort_auto]...
            = GenerateProb2ODESysMeshSymVel(xmesh, smesh, ones(1,11),...
                Lambda, arcLength); 
        elseif ODESystemType == 2
            [smesh, antwort1, antwort2,~,~, antwort5, antwort6, antwort7,...
                antwort_EVP, antwort_Infinite, antwort_endpoint, antwort_auto]...
